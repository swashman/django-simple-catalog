# Makefile for Django Simple Catalog

# Variables
appname = django-simple-catalog
appname_verbose = Django Simple Catalog
package = django_simple_catalog
